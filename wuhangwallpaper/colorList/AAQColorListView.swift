...
//        self.addSubview(searchBar)
    ...
    lazy var collectionView : UICollectionView = {
        ...
        flowLayout.itemSize = CGSize.init(width: YZWMathSize.rate(rate: 95), height: YZWMathSize.rate(rate: 180))
        flowLayout.minimumLineSpacing = YZWMathSize.rate(rate: 20)
        flowLayout.sectionInset = UIEdgeInsets.init(top: YZWMathSize.rate(rate: 10), left: YZWMathSize.rate(rate: 25), bottom: YZWMathSize.rate(rate: 10), right: YZWMathSize.rate(rate: 25))
